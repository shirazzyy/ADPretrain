...
from validate import calculate_scores_by_feature_norm
...
def main(args):   
    ...
    for class_name in CLASS_NAMES:
        ...
        metrics = calculate_scores_by_feature_norm(args, encoder, projectors, test_loader, ref_features[class_name] if args.with_pretrained else None,
                                                   args.device, class_name, residual=args.with_pretrained, aligned=args.aligned, pro=True)
        img_auc, img_ap, img_f1_score, pix_auc, pix_ap, pix_f1_score, pix_aupro = metrics
