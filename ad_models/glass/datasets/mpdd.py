...
class MPDDDataset(torch.utils.data.Dataset):
    ...
    def __init__(
        ...
        xlsx_path = './ad_models/glass/datasets/excel/' + self.dataset_name + '_distribution.xlsx'
    ...
    def __getitem__(self, idx):
        ...
        if self.split == DatasetSplit.TRAIN:
            ...
            if self.class_fg:
                fgmask_path = 'ad_models/glass/fg_mask/' + classname + '/' + os.path.split(image_path)[-1]
                mask_fg = Image.open(fgmask_path)
